@echo off
REM Script pour générer un fichier .env complet pour Aviatrax Studio

echo APP_NAME="Aviatrax Studio" > .env
...
echo DB_DATABASE=aviator_music_studio >> .env
echo DB_USERNAME=root >> .env
echo DB_PASSWORD=1999 >> .env
...
echo MAIL_FROM_NAME="Aviatrax Studio" >> .env
echo. >> .env
...
echo. >> .env
echo VITE_APP_NAME="Aviatrax Studio" >> .env
